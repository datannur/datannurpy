...
├── schema.py            # Dataclasses: Folder, Dataset, Variable, Enumeration, Value, Frequency, Organization, Tag, Doc
├── config/              # YAML config loader (run_config)
├── utils/               # Internal utilities (ids, log, enumeration, prefix, folder, time)
